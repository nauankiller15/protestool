...
function bemVindoLogado() {
  let bvExibida = getCookie("bvExibida");
  if (bvExibida == null || bvExibida == "false") {
    setTimeout(function () {
...
$(document).ready(function () {
  if (window.localStorage.getItem("bem_vindo_prot")) {
    bemVindoLogado().hide();
  }
});
...
function codretorno() {
  $("#codretorno").click(function () {
    toastr.info(
      "Esta página contém: Lista detalhada para especificar os códigos, o que cada um representa!"
    );
