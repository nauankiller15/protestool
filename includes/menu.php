<nav id="menu">
    <ul>
        <li><a href="http://localhost/ProtesTool/desvincular_daje.php">Desvincular Daje</a></li>
        <li><a href="http://localhost/ProtesTool/consulta_daje.php">Consultar Daje</a></li>
