...
<nav class="menu">
    <ul>
        ...
        <span data-tooltip2="Códigos de retorno"><li class="menu menu-link" id="codretorno" data-load-page="paginas_data/cods_retorno_page.php"><a><b><i class="fas fa-exclamation-circle"></i></b></a></li></span>
        <div class="tools">
