    ...
    <div class="popup">
        ...
        <form id="configip" class="api-request" data-endpoint="Config">
            ...
            <div class="centralizar3">
                <button type="button" class="btn3" id="salvar-configuracao-btn"><i class="fas fa-save"></i> Salvar</button> <button id="limparConfigBTN" type="reset" class="btnlimpar reset"><i class="far fa-times-circle"></i>
                    Limpar</button>
            </div>
        </form>
...
<div class="caixasair">
    <div id="popup2">
        <div class="popup">
            ...
            <div class="centralizar3">
                <a href="javascript: fechar2();"><button type="noexit" id="noexit" class="btn3"><i class="fas fa-undo-alt"></i> Voltar</button></a> <a href="index.php?logout='1'"><button id="exit" type="exit" class="btnlimpar"><i class="fas fa-power-off"></i> Sair</button></a>
            </div>
            </form>
        </div>
    </div>
